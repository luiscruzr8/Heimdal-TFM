package es.udc.tfm.heimdal.heimdal_server.config;

import com.fasterxml.jackson.databind.ObjectMapper;
import es.udc.tfm.heimdal.heimdal_server.auth.SecurityFilter;
import es.udc.tfm.heimdal.heimdal_server.auth.SecurityProperties;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public AuthenticationEntryPoint restAuthenticationEntryPoint() {
        return (httpServletRequest, httpServletResponse, e) -> {
            ...
            int errorCode = 401;
            errorObject.put("message", "Unauthorized access, invalid credentials");
